...
function Thrillfull() {
  ...
  useEffect(() => {
    async function fetchMovies() {
      try {
        const response = await axios.get(
          `https://api.themoviedb.org/3/discover/movie?api_key=${TMDB_API_KEY}&with_genres=9648&region=IN&with_original_language=hi&page=${page}&append_to_response=videos`
        );
